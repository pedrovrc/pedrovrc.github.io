...
function Apresentacao() {
  return (
    <section className="apresentacao">
      ...
      <p className="texto-regular">Sou um desenvolvedor de software em início de carreira, com 4+ anos de experiência
        em C/C++ e Python, atualmente estudando desenvolvimento web e buscando minha
        primeira oportunidade profissional na área.</p>
      <p className="texto-regular">Bem-vindo(a) ao meu site!</p>
      <div className="apresentacao-links">
        ...
        <a href="https://flowcv.com/resume/83n68qpal3r3" target="_blank" rel="noopener noreferrer" title="English Resume"><FaFilePdf /> EN</a>
      </div>
    </section>
  );
}
